...
| yg-requirement-reviewer | `/yg-requirement-reviewer` | 设计方案模拟推演审查 |
...
flowchart TD
    ...
    B -->|需求简单/模糊| C[yg-brainstorming<br/>头脑风暴完善]
    B -->|需求详细/明确| D[yg-requirement-extraction<br/>提取结构化需求]
    
    C --> E[yg-document-writing<br/>编写需求文档]
    D --> E
    
    E --> F[yg-requirement-reviewer<br/>评审文档质量]
    
    F --> G[yg-visualize<br/>文档可视化]
    F --> H[yg-prototyping<br/>原型生成]
